...
<div
  class="w-full bg-white rounded-lg py-2 px-4 flex space-x-2 items-center group border 
    border-slate-200 outline-red-500"
>
  <div
    class="w-4 h-4 text-sky-700  active:text-sky-700 hover:text-sky-800"
  >
